...
def train():
    ...
    model.fit_generator(
        [datagen.flow(X, Y, batch_size=_batch_size), X_tilda],
...
if __name__ == '__main__':
    ...
    model.fit_generator(
        createGenerator(X, X_tilda, Y, batch_size=_batch_size),
        samples_per_epoch=X.shape[0],
        nb_epoch=_nb_epoch,
        verbose=1)
